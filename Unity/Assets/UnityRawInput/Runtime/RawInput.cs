...
namespace UnityRawInput
{
    public static class RawInput
    {
        ...
        private static void SetHooks()
        {
            ...
            hooks.Add(Win32API.SetWindowsHookEx(HookType.WH_KEYBOARD_LL, HandleKeyboardProc, IntPtr.Zero, threadID));
            hooks.Add(Win32API.SetWindowsHookEx(HookType.WH_MOUSE_LL, HandleMouseProc, IntPtr.Zero, threadID));
        }
